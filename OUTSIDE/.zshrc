...
alias tt='fzf --preview '"'"'[[ $(file --mime {}) =~ binary ]] && echo {} is a binary file || (highlight 40% ansi -l {} || coderay {} || rougify {} || cat {}) 2> /dev/null | head -500'"'"
...
export PATH="/usr/local/lib/ruby/gems/2.7.0/gems/:$PATH"
